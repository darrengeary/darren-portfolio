    ...
    <section id='experience'>
      <div className='container px-5 py-10 mx-auto'>
        <div className='text-center mb-10'>
          ...
          <h1 className='sm:text-4xl text-3xl font-custom title-font text-white mb-4'>
            Work Experience
          </h1>
          <p className='text-base leading-relaxed xl:w-2/4 lg:w-3/4 md:px-10 mx-auto'>
            My most recent employers along with the duties and trainings
            encountered during my time in each role.
          </p>
        </div>
                ...
                <div className='flex justify-center'>
                  <div className='inline-flex items-center mb-4'>
                    ...
                    <span className='flex-grow flex flex-col pl-4'>
                      ...
                      <p className='text-gray-900'>{thisExperience.years}</p>
                    </span>
                  </div>
                </div>
                <div className='mt-4 text-left'>
                  {thisExperience.duties.map((data) => (
                    <div className='w-full text-gray-900 leading-relaxed inline-flex'>
                      <p>
                        <ClipboardCheckIcon className='w-4 h-4 mt-1.5 mr-4' />
                      </p>
                      <p>{data.duty}</p>
                    </div>
                  ))}
