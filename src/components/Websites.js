...
export default function Websites() {
  return (
    <section id='websites' className='text-gray-400 body-font'>
      <div className='container px-5 py-10 mx-auto text-center lg:px-40'>
        <div className='flex flex-col w-full mb-20 font-custom'>
          ...
          <p className='lg:w-2/3 mx-auto leading-relaxed text-base'>
            Deployed websites designed and built for two local businesses.
          </p>
        </div>
            ...
            >
              {(close) => (
                <div className='modal pb-8'>
                  ...
                  <img alt='gallery' className=' w-full' src={website.image} />
                  ...
                  <div className='actions buttons-cont'>
                    <button
                      ...
                      onClick={(e) => {
                        e.preventDefault()
                        window.location.href = website.git
                      }}
                    >
                      <svg
                        aria-hidden='true'
